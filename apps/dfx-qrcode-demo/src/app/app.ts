...
import { GithubButton, Layout, NpmButton, PackageManagerInstall, PlaygroundCodeSnippet, ThemeSwitch } from 'playground-lib';
...
export class App {
  form = inject(FormBuilder).nonNullable.group({
    ...
    imageSrc: ['/qrcode/angular-logo.png', [Validators.required]],
    imageWidth: [80, [Validators.required]],
    imageHeight: [80, [Validators.required]],
  });

  public formValues = toSignal(this.form.valueChanges.pipe(debounceTime(400)), {
