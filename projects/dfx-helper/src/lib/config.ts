...
export const HELPER_BASE_URL_INTERCEPTOR_IGNORE_PATHS = new InjectionToken<string[]>(
...
export const HELPER_LOGGING_INTERCEPTOR_IGNORE_PATHS = new InjectionToken<string[]>(
...
export const HELPER_POST_PUT_JSON_CONTENT_TYPE_INTERCEPTOR_IGNORE_PATHS = new InjectionToken<
  string[]
