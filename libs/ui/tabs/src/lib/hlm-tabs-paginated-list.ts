...
@Component({
  ...
  template: `
    ...
    <div class="z-[1] flex grow overflow-hidden" #tabListContainer (keydown)="_handleKeydown($event)">
      <div class="relative grow transition-transform" #tabList (cdkObserveContent)="_onContentChanges()" role="tablist">
